...
/**
 * Servlet implementation class FetchAvailableStock
 */
public class FetchAvailableStock extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		String query = "SELECT p.sku, IFNULL(oh.on_hand_quantity, 0) , IFNULL(DATE_FORMAT(oh.last_date_modified ,'%m/%d/%Y'), '') FROM product AS p LEFT JOIN on_hand AS oh ON p.sku = oh.skuID";
